...
export default function Footer() {
  return (
    ...
    <footer className="absolute w-full bottom-0 px-3 py-5 bg-white dark:bg-gray-800 text-2 text-gray-500 dark:text-gray-200 transition-colors duration-200">
      <div className="flex flex-col">
        ...
        <div className="mt-4 md:mt-0 flex flex-col md:flex-row">
          <nav className="flex-1 flex flex-col items-center justify-center md:items-end md:border-r border-gray-100 md:pr-5">
            ...
            <Link href="/about">
            <a aria-current="/" className="hover:text-gray-700 dark:hover:text-white">
              About
            </a>
            </Link>
          ...
          <div className="mt-7 md:mt-0 flex-1 flex flex-col items-center justify-center md:items-start md:pl-5">
            ...
            <span className="mt-7 md:mt-1">
              Created by <br />
              <a className="underline hover:text-primary-gray-20" href="https://github.com/lolzone13">
                Lolzone13
              </a>
            </span>
          </div>
